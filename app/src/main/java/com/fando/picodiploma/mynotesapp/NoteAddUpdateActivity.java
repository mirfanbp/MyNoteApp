...
import static com.fando.picodiploma.mynotesapp.db.DatabaseContract.NoteColumns.DATE;
import static com.fando.picodiploma.mynotesapp.db.DatabaseContract.NoteColumns.DESCRIPTION;
import static com.fando.picodiploma.mynotesapp.db.DatabaseContract.NoteColumns.TITLE;
...
public class NoteAddUpdateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_submit) {
            ...
            // Setiap aksi akan mengirimkan data dan RESULT_CODE
            ...
            if (isEdit) {
                ...
                // penambahan data pada NoteHelper
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (isDialogClose) {
                            ...
                            if (result > 0) {
                                ...
                                Toast.makeText(NoteAddUpdateActivity.this, "Gagal menghapus dtta", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                })
